...
export default {
  ...
  ACTION_TYPE: {
    ...
    VERIFY_RESERVE_WORDS_REQUEST: 'VERIFY_RESERVE_WORDS_REQUEST',
    VERIFY_RESERVE_WORDS_SUCCESS: 'VERIFY_RESERVE_WORDS_SUCCESS',
    VERIFY_RESERVE_WORDS_FAIL: 'VERIFY_RESERVE_WORDS_FAIL',
