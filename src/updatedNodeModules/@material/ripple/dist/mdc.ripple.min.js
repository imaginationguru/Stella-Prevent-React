        ...
        1: function (t, e, n) {
          ...
          var r =
              ...
              function (t, e) {
                ...
                var i,
                  ...
                  o = [];
                try {
                  for (; (void 0 === e || 0 < e--) && !(i = a.next()).done; )
                    o.push(i.value);
                } catch (t) {
                  r = {error: t};
                } finally {
          ...
          function s(t, e) {
            for (var n = [], i = 2; i < arguments.length; i++)
              n[i - 2] = arguments[i];
            (this.root = t),
              this.initialize.apply(this, a([], r(n))),
              (this.foundation =
          ...
          var s,
            ...
            v =
              ...
              (h.prototype.destroy = function () {
                ...
                if (this.supportsPressRipple()) {
                  this.activationTimer &&
                    ...
                    this.adapter.removeClass(h.cssClasses.FG_ACTIVATION)),
                    this.fgDeactivationRemovalTimer &&
                      (clearTimeout(this.fgDeactivationRemovalTimer),
                      (this.fgDeactivationRemovalTimer = 0),
                      this.adapter.removeClass(h.cssClasses.FG_DEACTIVATION));
                  var e = h.cssClasses,
                    n = e.ROOT,
                    i = e.UNBOUNDED;
                  requestAnimationFrame(function () {
              ...
              (h.prototype.animateActivation = function () {
                ...
                this.adapter.updateCssVariable(n, u),
